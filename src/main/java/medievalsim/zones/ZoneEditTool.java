...
implements GameTool {
    ...
    public void init() {
        this.hudElement = new HudDrawElement(){
            ...
            public void addDrawables(List<SortedDrawable> list, GameCamera camera, PlayerMob perspective) {
                ...
                Zoning zoning = ZoneEditTool.this.zone.zoning;
                synchronized (zoning) {
    ...
    tooltips.add(new InputTooltip(-100, Localization.translate((String)"ui", (String)"expandzone")));
    tooltips.add(new InputTooltip(-99, Localization.translate((String)"ui", (String)"shrinkzone")));
    tooltips.add(new InputTooltip(256, Localization.translate((String)"ui", (String)"cancel")));
        return tooltips;
    }
}
