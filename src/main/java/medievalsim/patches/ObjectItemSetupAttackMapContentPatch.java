...
@ModMethodPatch(target=ObjectItem.class, name="setupAttackMapContent", arguments={GNDItemMap.class, Level.class, int.class, int.class, ItemAttackerMob.class, int.class, InventoryItem.class})
public class ObjectItemSetupAttackMapContentPatch {
    @Advice.OnMethodExit
