/*
 * Shape calculation utilities for build mode tools
 * Generates coordinate lists for various geometric shapes
 */
            ...
            case 5: {
                ...
                for (int x = 0; x < squareSize; ++x) {
                    for (int y = 0; y < squareSize; ++y) {
                        boolean isEdge = x == 0 || x == squareSize - 1 || y == 0 || y == squareSize - 1;
            ...
            case 6: {
                ...
                for (int x = -radius; x <= radius; ++x) {
                    for (int y = -radius; y <= radius; ++y) {
                        ...
                        boolean onEdge = Math.abs(distance - (double)radius) <= edgeThickness;
            ...
            case 7: {
                ...
                for (int x = -diamondSize; x <= diamondSize; ++x) {
                    for (int y = -diamondSize; y <= diamondSize; ++y) {
                        ...
                        boolean onEdge = manhattanDist == diamondSize;
