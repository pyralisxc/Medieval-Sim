...
extends GameObject {
    ...
    public String getInteractTip(Level level, int x, int y, PlayerMob perspective, boolean debug) {
        ...
        if (zoneData != null) {
            for (PvPZone zone : zoneData.getPvPZones().values()) {
                ...
                int playerTileY = GameMath.getTileCoordinate((int)((int)perspective.y));
                boolean playerInZone = zone.containsTile(playerTileX, playerTileY);
    ...
    public void interact(Level level, int x, int y, PlayerMob player) {
        ...
        for (PvPZone zone : zoneData.getPvPZones().values()) {
            ...
            int playerTileY = GameMath.getTileCoordinate((int)((int)player.y));
            boolean playerInZone = zone.containsTile(playerTileX, playerTileY);
            if (playerInZone) {
